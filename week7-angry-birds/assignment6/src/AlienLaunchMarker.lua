...
function AlienLaunchMarker:handleLaunch()
    self.launched = true
...
function AlienLaunchMarker:handleAim()
...
function AlienLaunchMarker:renderTrajectory()
    ...
    local _, gravY = self.world:getGravity()
