...
function PlayState:init()
    ...
    self.player.stateMachine = StateMachine {
        ...
        ['idle-carry-item'] = function() return PlayerCarryItemIdleState(self.player, self.dungeon) end,
        ['walk-carry-item'] = function() return PlayerCarryItemWalkState(self.player, self.dungeon) end
    }
